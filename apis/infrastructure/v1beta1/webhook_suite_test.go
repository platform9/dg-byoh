...
var _ = BeforeSuite(func() {
	...
	mgr.GetWebhookServer().Register("/validate-infrastructure-cluster-x-k8s-io-v1beta1-byohost", &webhook.Admission{Handler: &byohv1beta1.ByoHostValidator{Client: mgr.GetClient()}})
